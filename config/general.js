module.exports = {
  ...
  auth: {
    GOOGLE_CLIENT_ID: process.env.GOOGLE_CLIENT_ID || '<Create credentials from Google Dev Console>',
    GOOGLE_CLIENT_SECRET: process.env.GOOGLE_CLIENT_SECRET || '<Create credentials from Google Dev Console>'
  },
